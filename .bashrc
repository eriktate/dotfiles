...
export ROCKETMONEY_MONOREPO=/Users/ETate1/rkt/rocketmoney

source /Users/ETate1/rkt/rocketmoney/scripts/rocket_money_global_config
export JAVA_HOME='/Applications/Android Studio.app/Contents/jbr/Contents/Home' # set by tb-bootstrap-android
export ANDROID_HOME="/Users/ETate1/Library/Android/sdk" # set by tb-bootstrap-android
export PATH="$PATH:$ANDROID_HOME/emulator" # set by tb-bootstrap-android
export PATH="$PATH:$ANDROID_HOME/tools" # set by tb-bootstrap-android
export PATH="$PATH:$ANDROID_HOME/tools/bin" # set by tb-bootstrap-android
export PATH="$PATH:$ANDROID_HOME/platform-tools" # set by tb-bootstrap-android
export JAVA_HOME='/Applications/Android Studio.app/Contents/jbr/Contents/Home' # set by tb-bootstrap-android
export ANDROID_HOME="/Users/ETate1/Library/Android/sdk" # set by tb-bootstrap-android
export PATH="$PATH:$ANDROID_HOME/emulator" # set by tb-bootstrap-android
export PATH="$PATH:$ANDROID_HOME/tools" # set by tb-bootstrap-android
