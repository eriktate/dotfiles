...
xrandr \
	--output HDMI-0 --primary --mode 3840x2160 --rate 120 --pos 0x1080 --scale 1x1 \
...
xinput --set-prop "pointer:  Hitscan 8k Dongle Mouse" "libinput Accel Speed" -0.65
xinput --set-prop "pointer:  Hitscan 8k Dongle" "libinput Accel Speed" -0.65
